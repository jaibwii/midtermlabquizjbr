  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: const Color.fromRGBO(239, 1, 7, 10),
          ...
          Padding(
            ...
            child: ElevatedButton.icon(
              ...
              builder: (context) => const IconTheme(
                data: IconThemeData(color:  Color.fromRGBO(156, 130, 74 ,10)), // Change this to your desired icon color
              ...
              style: ElevatedButton.styleFrom(
                ...
                foregroundColor: const Color.fromRGBO(156, 130, 74 ,10), // Change this to your desired text and icon color
              ),
            ),
          ),
        ],
